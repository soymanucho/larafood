                        ...
                        @else
                          <li class="nav-item dropdown">
                              ...
                              <div class="dropdown-menu dropdown-menu-right user-dd animated">
                                  ...
                                  <div class="dropdown-divider"></div>
                                  <a class="dropdown-item" target="_blank" href="https://github.com/soymanucho/larafood"><i class="ti-github m-r-5 m-l-5"></i> Github </a>
                                  <div class="dropdown-divider"></div>
                                  <a class="dropdown-item " target="_blank" href="https://trello.com/b/sz6cvOia/larafood"><i class="ti-trello m-r-5 m-l-5"></i> Trello</a>
                                  <div class="dropdown-divider"></div>
                                  <a class="dropdown-item" href="javascript:void(0)"><i class="ti-settings m-r-5 m-l-5"></i> Ajustes de cuenta</a>
                                  <div class="dropdown-divider"></div>
